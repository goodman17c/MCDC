...
def particle_bank(max_size):
    return np.dtype(
        [("particles", particle_record, (max_size,)), ("size", uint64), ("tag", "U10")]
    )
...
def make_type_tally(card):
    ...
    scores_shapes = [
        ...
        ["n_x", (Ng, Nt, Nx + 1, Ny, Nz, Nmu, N_azi)],
        ...
        ["n_y", (Ng, Nt, Nx, Ny + 1, Nz, Nmu, N_azi)],
        ...
        ["n_z", (Ng, Nt, Nx, Ny, Nz + 1, Nmu, N_azi)],
        ...
        ["n_t", (Ng, Nt + 1, Nx, Ny, Nz, Nmu, N_azi)],
