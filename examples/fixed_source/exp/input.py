...
mcdc.tally(scores=["flux", "n"], x=np.linspace(-0.01, 3.0, 302))

# Setting
mcdc.setting(N_particle=1e3, active_bank_buff=1e4)

# Technique
# mcdc.implicit_capture()

mcdc.weight_window(
    x=[-1.0, 1.0, 2.0, 4.0], rho=1.0, wwtype="isotropic", window=[1.0, 0.5, 0.0]
)
