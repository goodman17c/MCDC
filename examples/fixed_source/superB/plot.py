...
def add_to_plot(i, j, k, l):
    ...
    with h5py.File(file, "r") as f:
        ...
        # plt.semilogy(x_mid,phi_t_ref[0])
        # plt.semilogy(x_mid,phi_t_ref[4])
        # plt.semilogy(x_mid,phi_t_ref[9])
        # plt.semilogy(x_mid,phi_t_ref[14])
        # plt.semilogy(x_mid,phi_t_ref[19])
        plt.plot(x_mid, phi_t_ref[0])
        plt.plot(x_mid, phi_t_ref[4])
        plt.plot(x_mid, phi_t_ref[9])
        plt.plot(x_mid, phi_t_ref[14])
        plt.plot(x_mid, phi_t_ref[19])
