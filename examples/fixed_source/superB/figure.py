...
def add_to_plot(i, j, k,l):
		...
		with h5py.File(file, 'r') as f:
				...
				#plt.semilogy(t[1:],missing_domain,label=file)
...
#	for j in range(3):
		...
		#add_to_plot(2,i+1,j)
		#add_to_plot(3,i+1,j)
add_to_plot(1,0,0,40000)
add_to_plot(2,2,0,40000)
add_to_plot(4,2,0,40000)
add_to_plot(5,2,0,40000)
#add_to_plot(6,2,2,40000)
